...
export type Model = IFieldParent & IModel & {
  __typename?: 'Model';
  apiId: Scalars['String']['output'];
  apiIdPlural: Scalars['String']['output'];
  contentViews: Array<ContentView>;
...
export type _UpdatePlanTrialPayload = {
  ...
  "possibleTypes": {
    ...
    "IContentPermission": [
      ...
      "PublishContentPermission",
      "ReadContentPermission",
      "ReadVersionContentPermission",
      "UnpublishContentPermission",
      "UpdateContentPermission"
    ],
    "IContentViewColumn": [
      "ContentViewFieldColumn",
      "ContentViewSystemColumn"
    ],
    "IExtension": [
      "FieldExtension",
      "SidebarExtension"
    ...
    "IRemoteFieldConfig": [
      "GraphQLRemoteFieldConfig",
      "RestRemoteFieldConfig"
    ],
    "IRemoteSource": [
      "GraphQLRemoteSource",
      "RESTRemoteSource"
    ...
    "ISchemaMigrationPayload": [
      "SchemaMigrationSubscriptionPayload",
      "SchemaMigrationSucceededSubscriptionPayload"
    ],
    "ISidebarElement": [
      "AppSidebarElement",
      "CustomSidebarElement",
      "ExtensionSidebarElement",
      "SystemSidebarElement"
    ],
    "ITemplate": [
      "StarterTemplate",
      "Template"
    ...
    "NetlifyStateTriggeredBy": [
      "Member",
      "PermanentAuthToken"
    ],
    "ProjectChangedPayload": [
      "ProjectChangeCompletedCloning"
    ],
    "SidebarElements": [
      "AppSidebarElement",
      "CustomSidebarElement",
...
export type GlobalConfigQuery = { __typename?: 'Query', viewer: { __typename?: 'AppTokenViewer' } | { __typename?: 'TokenViewer' } | { __typename?: 'UserViewer', id: string, app: { __typename?: 'App', id: string, apiId: string, elements?: Array<{ __typename?: 'FieldAppElement', apiId: string, config?: any | null } | { __typename?: 'FormSidebarAppElement', apiId: string, config?: any | null } | { __typename?: 'PageAppElement', id: string, name: string, apiId: string, config?: any | null, type: AppElementType }> | null } } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GlobalConfig(variables?: GlobalConfigQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GlobalConfigQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GlobalConfigQuery>(GlobalConfigDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GlobalConfig', 'query', variables);
    }
  };
}
