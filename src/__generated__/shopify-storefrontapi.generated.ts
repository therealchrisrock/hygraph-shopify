...
export type CollectionFragment = { __typename?: 'Collection', id: string, title: string, handle: string, description: string };
...
export type GetCollectionQuery = { __typename?: 'QueryRoot', collection?: { __typename?: 'Collection', id: string, title: string, handle: string, description: string } | null };
...
export type GetProductQuery = { __typename?: 'QueryRoot', product?: { __typename?: 'Product', id: string, title: string, handle: string, description: string } | null };

export type ProductFragment = { __typename?: 'Product', id: string, title: string, handle: string, description: string };

export type GetShopQueryVariables = Exact<{ [key: string]: never; }>;


export type GetShopQuery = { __typename?: 'QueryRoot', shop: { __typename?: 'Shop', id: string, description?: string | null, name: string } };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    GetShop(variables?: GetShopQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetShopQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetShopQuery>(GetShopDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetShop', 'query', variables);
    }
  };
}
